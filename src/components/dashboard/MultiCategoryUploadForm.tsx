    ...
    <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-xs border border-gray-200 overflow-hidden">
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex gap-3 justify-end border-t border-gray-200 pt-6">
          <button
            type="submit"
            className="px-5 py-2.5 bg-linear-to-r from-green-600 to-green-700 text-white font-semibold rounded-lg hover:shadow-lg transform hover:-translate-y-0.5 transition-all disabled:opacity-50 capitalize tracking-wide flex items-center gap-2 cursor-pointer"
            disabled={isLoading}
          >
            {isLoading ? (
              <>
