          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="relative flex gap-3">
              ...
              <button
                ...
                className="px-6 py-3 bg-linear-to-r from-red-600 to-red-700 text-white font-bold rounded-lg hover:shadow-lg transform hover:-translate-y-0.5 transition-all uppercase tracking-wide disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none cursor-pointer flex items-center gap-2"
              >
